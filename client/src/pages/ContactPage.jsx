            ...
            {contactMethods.map((method, index) => (
              <AnimatedSection key={index} delay={index * 100}>
                <div className="bg-light rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 h-full flex flex-col">
                  ...
                  <a 
                    href={method.link}
                    className="inline-flex items-center text-primary font-inter font-semibold hover:text-secondary transition-colors mt-auto"
                  >
                    {method.action}
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-gray-700 font-inter font-semibold mb-2">
                        Your Name *
                      </label>
                      <input 
                        type="text" 
                  ...
                  <button 
                    type="submit"
                    className="w-full bg-primary hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
                  >
            ...
            <AnimatedSection delay={200}>
              <div className="space-y-8">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                  <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.936544921918!2d72.5849049153928!3d23.02664322207907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e84f4f4f4f4f5%3A0x1b5b5b5b5b5b5b5b!2sAhmedabad%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1620210210210!5m2!1sen!2sin" 
                      width="100%" 
                      height="384" 
                      style={{ border:0 }} 
                      allowFullScreen="" 
                ...
                <div className="bg-gradient-to-r from-primary to-red-700 rounded-2xl p-8 text-white">
                  <div className="flex items-start space-x-4">
                    <FontAwesomeIcon icon={faHeadset} className="text-2xl mt-1" />
                    <div>
